...
describe('UpdateUserRequestDto', () => {
  it('should create a valid UpdateUserRequestDto instance', () => {
    const dto = new UpdateUserRequestDto();
    dto.name = 'John Doe';
    dto.email = 'john.doe@example.com';
    dto.phone = '1234567890';

    expect(dto).toBeInstanceOf(UpdateUserRequestDto);
    expect(dto.name).toBe('John Doe');
    expect(dto.email).toBe('john.doe@example.com');
    expect(dto.phone).toBe('1234567890');
  });

  it('should create a UpdateUserRequestDto from plain object', () => {
    const plainObject = {
      name: 'John Doe',
      email: 'john.doe@example.com',
      phone: '1234567890',
    };
    const dto = plainToInstance(UpdateUserRequestDto, plainObject);
  ...
  it('should create a UpdateUserRequestDto with partial fields', () => {
    const plainObject = {
      name: 'John Doe',
    };
    const dto = plainToInstance(UpdateUserRequestDto, plainObject);
...
describe('UpdateUserResponseDto', () => {
  it('should create a valid UpdateUserResponseDto instance', () => {
    ...
    expect(dto).toBeInstanceOf(UpdateUserResponseDto);
  ...
  it('should create a UpdateUserResponseDto from plain object', () => {
    const createdAt = new Date('2023-01-01T00:00:00Z');
    const updatedAt = new Date('2023-01-02T00:00:00Z');
    ...
    const dto = plainToInstance(UpdateUserResponseDto, plainObject);
  ...
  it('should create a UpdateUserResponseDto from plain object with string dates', () => {
    const plainObject = {
      id: '123e4567-e89b-12d3-a456-426614174000',
      name: 'John Doe',
      email: 'john.doe@example.com',
